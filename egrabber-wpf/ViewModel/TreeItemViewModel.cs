...
namespace EGrabberWPF.ViewModel
{
	/// <summary>
	...
	public class TreeItemViewModel : INotifyPropertyChanged
	{
		...
		#region Constructor
		public TreeItemViewModel(TreeItemViewModel parent, bool lazyLoadChildren, bool isRootNode)
		{
			this.parent = parent;
		...
		protected virtual void LoadChildren()
		{
			for (int i = 0; i < 100; i++)
			{
				Children.Add(new TreeItemViewModel(this, true,false) { DisplayName = "subnode " + i });
			}
		}
